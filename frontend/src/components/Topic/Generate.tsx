    ...
    return <div className="h-full w-full flex">{
        part
            ? <div className="m-auto">
                <div className="flex flex-col items-center gap-5">
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <p className="text-xl">The AI is crafting a unique prompt based on TOEIC standards</p>
                    </div>
                    <BarLoader width={300} />
                </div>
            </div>
            : <div className="m-auto w-150">
                <div
                    className="w-fit flex py-3 flex-row items-center text-slate-400 hover:text-slate-800 cursor-pointer transition-all duration-200"
                ...
                <div className="border-2 rounded-md p-5">
                    ...
                    <div className="w-full mt-4 flex flex-col gap-2">
                        ...
                        >
                            ...
                            <ChevronRight
                                className="ml-auto size-10 opacity-0 group-hover:opacity-100 group-hover:translate-x-2 transition-all  duration-200"
                            />
                        </div>
                        <div
